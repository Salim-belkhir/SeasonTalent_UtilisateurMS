...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, UserKafka> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(consumerConfig());
    }

    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, UserKafka>> factory(
            ConsumerFactory<String, UserKafka> consumerFactory
    ){
